...
public class CreateAccountView extends JFrame {
    ...
    private final JLabel lblTitle = new JLabel("TẠO TÀI KHOẢN");
    ...
    private final JSpinner spnAge = new JSpinner(new SpinnerNumberModel(18, 1, 120, 1));
    private final JPanel buttonPanel = new JPanel();
    private final JButton btnBack = new JButton("Trở lại");
    private final JButton btnSubmit = new JButton("Xác nhận");
